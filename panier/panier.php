        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-none d-sm-none d-md-block">
                    <a href="../index.php" class="nav-brand nav-link d-flex justify-content-center lign-items-center">
                        ...
                        <li class="nav-item">
                            <a href="panier.php" class="nav-link text-dark">
                                <div class="cart">
                                    ...
                                    <span class="number bg-danger text-white rounded-circle fs-6"><?= count($produitsPanier) ?></span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="cart-content mb-3">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <button class="btn btn-outline-danger">
                                        <a href="deletepanier.php?idproduit=<?= $produitPanier['id'] ?>" class="nav-link"> <i class="bi bi-trash"></i> supprimer</a>
                                    </button>
                                    <div>
