            ...
            <div class="d-flex">
                <div>
                    <ul class="aside px-3 shadow">
                        <h6>Categories</h6>
                        <li class="nav-item">
                            <a href="produits.php" class="nav-link">Tout les Produits</a>
                        </li>
                        <li class="nav-item">
                            <a href="femme.php" class="nav-link">Accessoires Femmes</a>
                        </li>
                        <li class="nav-item">
                            <a href="homme.php" class="nav-link">Chaussures Hommes</a>
                        </li>
                    </ul>
                </div>
                <div class="container">
